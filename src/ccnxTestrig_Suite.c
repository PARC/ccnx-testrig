...
ccnxTestrigSuite_FIBTest_SimpleExchange(CCNxTestrig *rig, char *testCase)
{
    ...
    if (receivedInterestBuffer == NULL) {
        CCNxTestrigSuiteTestResult *failure = ccnxTestrigSuiteTestResult_CreateFail(testCase, "Failed to receive a packet from the forwarder.");
        return failure;
    }
    ...
    if (ccnxMetaMessage_IsInterest(reconstructedInterest)) {
        CCNxTestrigSuiteTestResult *failure = ccnxTestrigSuiteTestResult_CreateFail(testCase, "Expected the received message to be an interest.");
        return failure;
    }
    ...
    if (interestError != CCNxInterestFieldError_None) {
        CCNxTestrigSuiteTestResult *failure = ccnxTestrigSuiteTestResult_CreateFail(testCase, "An interest field was incorrect");
        return failure;
    }
    ...
    if (ccnxMetaMessage_IsContentObject(reconstructedContent)) {
        CCNxTestrigSuiteTestResult *failure = ccnxTestrigSuiteTestResult_CreateFail(testCase, "Expected the received message to be a content object.");
        return failure;
    }
    ...
    CCNxTestrigSuiteTestResult *testResult = ccnxTestrigSuiteTestResult_CreatePass(testCase);
    return testResult;
}

static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_FIBTest_BasicInterest_1a(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
    CCNxName *testName = ccnxName_CreateFromCString("ccnx:/test/b");
    assertNotNull(testName, "The name must not be NULL");
...
static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_FIBTest_BasicInterest_1b(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
    CCNxName *testName = ccnxName_CreateFromCString("ccnx:/test/c");
    assertNotNull(testName, "The name must not be NULL");
...
// Request object
static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_ContentObjectTest_1(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
...
static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_ContentObjectTest_2(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
    CCNxName *testName = _createRandomName("ccnx:/test/b");
    CCNxInterest *interest = ccnxInterest_Create(testName, 1000, NULL, NULL);
    ...
    if (ccnxMetaMessage_IsManifest(reconstructedManifest)) {
        CCNxTestrigSuiteTestResult *failure = ccnxTestrigSuiteTestResult_CreateFail(testCase, "Expected the received message to be a manifest.");
        return failure;
    }
...
static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_ContentObjectTest_3(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
...
static CCNxTestrigSuiteTestResult *
ccnxTestrigSuite_ContentObjectTest_4(CCNxTestrig *rig, char *testCase)
{
    // Create the test packets
